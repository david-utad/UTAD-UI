...
class AUTAD_UI_FPSCharacter : public ACharacter
{
  ...
  /** Skill Tree Show Input Action */
  UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Input, meta = (DisplayName = "Skill Tree", AllowPrivateAccess = "true"))
  class UInputAction* m_pSkillTreeAction;
...
protected:
  ...
  /**
   * It shows/hides the skill tree screen.
   */
  void SkillTreeScreen();
...
private:
  ...
  USkillTreeWidget* m_pSkillTreeInstance;
};
